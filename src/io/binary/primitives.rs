...
mod test {
    ...
    fn test_store() {
        ...
        test::test_store(
            Little,
            &float64,
            &[0xef, 0xcd, 0xab, 0x89, 0x25, 0x49, 0x12, 0x3e],
        );
        test::test_store(
            Big,
            &float64,
            &[0x3e, 0x12, 0x49, 0x25, 0x89, 0xab, 0xcd, 0xef],
        );
    }
...
mod test_vec {
    ...
    fn test_store() {
        ...
        let vecf =
            Vec::<f32>::from(&unsafe { transmute::<_, [f32; 2]>([0x3e124925u32, 0x6537851a]) }[..]);
        test::test_store(
            Little,
            &vecf,
        ...
        let vecd = Vec::<f64>::from(
            &unsafe { transmute::<_, [f64; 2]>([0x3e12492589abcdefu64, 0x3fae1e1f3ac15743]) }[..],
        );
        test::test_store(
            Little,
            &vecd,
